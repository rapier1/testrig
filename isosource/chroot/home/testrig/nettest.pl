...
# in case thw networking didn't come up correctly explicitly
...
# OKAY the above doesn't work because router won't get the defaul intreface if
# the interafce isn't up and doens't have an ip address. We need to get a full list of
# the interafces and pick one to try and bring up. Which is stupid and sucks. We could grep
# dmesg and look to see how eth0 is renamed. However, this is a problem when we ony have
